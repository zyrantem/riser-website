...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Mobile hero buttons functionality
    function initMobileHeroButtons() {
        const mobileButtons = document.querySelectorAll('.hero-mobile-btn');
        mobileButtons.forEach(button => {
            button.addEventListener('click', function(e) {
                e.preventDefault();
                const audience = this.getAttribute('data-audience');
                
                // Switch to the correct audience if needed
                if (audience === 'hirers') {
                    document.getElementById('toggle-hirers').checked = true;
                    document.getElementById('hirers-content').classList.add('active');
                    document.getElementById('talent-content').classList.remove('active');
                } else if (audience === 'talent') {
                    document.getElementById('toggle-talent').checked = true;
                    document.getElementById('talent-content').classList.add('active');
                    document.getElementById('hirers-content').classList.remove('active');
                }
